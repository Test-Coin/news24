...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("News24Coin Core News24-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  News24-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded News24 transaction") + "\n" +
                               "  News24-tx [options] -create [commands]   " + _("Create hex-encoded News24 transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded News24 transaction
