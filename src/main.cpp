...
int64_t GetBlockValue(int nHeight)
{
    ...
    if (nHeight == 0){
      nSubsidy = 24242 * COIN;
    } else if (nHeight <= 500 && nHeight > 0 ) {   //instamine
     nSubsidy = 0.10 * COIN;
    } else if (nHeight <= 2500 && nHeight > 500) {
        nSubsidy = 2.4 * COIN;
    } else if (nHeight <= 2600 && nHeight > 2500) {
        nSubsidy = 24 * COIN;
	} else if (nHeight <= 4100 && nHeight > 2600){
        nSubsidy = 2.4 * COIN;
	} else if(nHeight <= 4200 && nHeight > 4100){
      nSubsidy = 24 * COIN;
    } else if(nHeight <= 5700 && nHeight > 4200){
      nSubsidy = 2.4 * COIN;
    } else if(nHeight <= 5800 && nHeight > 5700){
      nSubsidy = 24 * COIN;
    } else if(nHeight <= 7300 && nHeight > 5800){
      nSubsidy = 2.4 * COIN;
    } else if(nHeight <= 7400 && nHeight > 7300){
      nSubsidy = 24 * COIN;
    } else if(nHeight <= 8900 && nHeight > 7400){
      nSubsidy = 2.4 * COIN;
    } else if(nHeight <= 9000 && nHeight > 8900){
      nSubsidy = 24 * COIN;
    } else if(nHeight <= 10000 && nHeight > 9000){
      nSubsidy = 2.4 * COIN;
    } else if(nHeight <= 10100 && nHeight > 10000){
      nSubsidy = 24 * COIN;
    } else if(nHeight <= 20000 && nHeight > 10100){
      nSubsidy = 2.4 * COIN;
    } else if(nHeight <= 20100 && nHeight > 20000){
      nSubsidy = 24 * COIN;
    } else if(nHeight <= 30000 && nHeight > 20100){
      nSubsidy = 2.4 * COIN;
    } else if(nHeight <= 30100 && nHeight > 30000){
      nSubsidy = 24 * COIN;
    } else if(nHeight <= 40000 && nHeight > 30100){
      nSubsidy = 2.4 * COIN;
    } else if(nHeight <= 40100 && nHeight > 40000){
      nSubsidy = 24 * COIN;
    } else if(nHeight <= 50000 && nHeight > 40100){
      nSubsidy = 2.4 * COIN;
    } else if(nHeight <= 50100 && nHeight > 50000){
      nSubsidy = 24 * COIN;
    } else if(nHeight <= 60000 && nHeight > 50100){
      nSubsidy = 2.4 * COIN;
    } else if(nHeight <= 60100 && nHeight > 60000){
      nSubsidy = 24 * COIN;
    } else if(nHeight <= 70000 && nHeight > 60100){
      nSubsidy = 2.4 * COIN;
    } else if(nHeight <= 70100 && nHeight > 70000){
      nSubsidy = 24 * COIN;
    } else if(nHeight <= 80000 && nHeight > 70100){
      nSubsidy = 2.4 * COIN;
    } else if(nHeight <= 80100 && nHeight > 80000){
      nSubsidy = 24 * COIN;
    } else if(nHeight <= 90000 && nHeight > 80100){
      nSubsidy = 2.4 * COIN;
    } else if(nHeight <= 91000 && nHeight > 90000){
      nSubsidy = 24 * COIN;
    } else if(nHeight <= 100000 && nHeight > 90100){
      nSubsidy = 2.4 * COIN;
