...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* News24Coin features */
        {"News24", "masternode", &masternode, true, true, false},
        {"News24", "masternodelist", &masternodelist, true, true, false},
        {"News24", "mnbudget", &mnbudget, true, true, false},
        {"News24", "mnbudgetvoteraw", &mnbudgetvoteraw, true, true, false},
        {"News24", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"News24", "mnsync", &mnsync, true, true, false},
        {"News24", "spork", &spork, true, true, false},
#ifdef ENABLE_WALLET
        {"News24", "obfuscation", &obfuscation, false, false, true}, /* not threadSafe because of SendMoney */
...
void StartRPCThreads()
{
    ...
    if (((mapArgs["-rpcpassword"] == "") ||
        ...
        uiInterface.ThreadSafeMessageBox(strprintf(
                                             _("To use News24d, or the -server option to News24-qt, you must set an rpcpassword in the configuration file:\n"
                                               "%s\n"
...
{
    return "> News24-cli " + methodname + " " + args + "\n";
}
...
std::string HelpExampleRpc(string methodname, string args)
{
    return "> curl --user myusername --data-binary '{\"jsonrpc\": \"1.0\", \"id\":\"curltest\", "
           "\"method\": \"" +
           methodname + "\", \"params\": [" + args + "] }' -H 'content-type: text/plain;' http://127.0.0.1:9251/\n";
}
