Contributing to News24Coin Core
============================

The News24Coin Core project operates an open contributor model where anyone is
...
The following applies to code changes to the News24Coin Core project, and is not to be
confused with overall News24Coin Network Protocol consensus changes.

Whether a pull request is merged into News24Coin Core rests with the project merge
...
Patches that change News24Coin consensus rules are considerably more involved than
...
Where a patch set proposes to change the News24Coin consensus, it must have been
...
The project leader is the release manager for each News24Coin Core release.
