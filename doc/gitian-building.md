...
- [Building News24Coin](#building-News24)
...
Clone the git repositories for News24 and gitian and then checkout the News24 version that you want to build.

```bash
git clone https://github.com/devrandom/gitian-builder.git
git clone https://github.com/News24-crypto/News24.git
cd News24
...
Follow the instructions in [doc/release-process.md](release-process.md) in the News24 repository
...
gitian builds' in [doc/release-process.md](release-process.md) in the News24 repository.
...
```bash
    Initialized empty Git repository in /home/debian/gitian-builder/inputs/News24/.git/
    remote: Reusing existing pack: 35606, done.
    remote: Total 35606 (delta 0), reused 0 (delta 0)
    Receiving objects: 100% (35606/35606), 26.52 MiB | 4.28 MiB/s, done.
    Resolving deltas: 100% (25724/25724), done.
    From https://github.com/News24-crypto/News24
...
For example:
```bash
URL=https://github.com/crowning-/News24.git
COMMIT=b616fb8ef0d49a919b72b0388b091aaec5849b96
./bin/gbuild --commit News24=${COMMIT} --url News24=${URL} ../News24/contrib/gitian-descriptors/gitian-linux.yml
./bin/gbuild --commit News24=${COMMIT} --url News24=${URL} ../News24/contrib/gitian-descriptors/gitian-win.yml
./bin/gbuild --commit News24=${COMMIT} --url News24=${URL} ../News24/contrib/gitian-descriptors/gitian-osx.yml
```
...
```bash
    gpg --detach-sign ${VERSION}-linux/${SIGNER}/News24-build.assert
    gpg --detach-sign ${VERSION}-win/${SIGNER}/News24-build.assert
    gpg --detach-sign ${VERSION}-osx/${SIGNER}/News24-build.assert
```
...
[News24/gitian.sigs](https://github.com/News24-crypto/gitian.sigs/) repository, or if that's not possible to create a pull
request.
