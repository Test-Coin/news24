...
In order to support loading of multiple wallets in News24-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is News24.cpp.
...
Changes to News24.cpp
----------------------
News24.cpp is the entry point into News24-qt, and as such, will require some minor modifications to provide hooks for
